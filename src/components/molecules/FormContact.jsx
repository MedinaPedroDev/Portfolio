...
function FormContact() {
  ...
  return (
    <form className='bg-neutral-300 dark:bg-slate-950 w-full md:w-[8 0%] lg:w-[40%] flex flex-col justify-between gap-8 p-8 rounded-2xl border-1 border-black/50 dark:border-amber-100/50'
    ...
    >
      ...
      <button className='rounded-full py-2 px-8 bg-sky-500 max-w-max mx-auto cursor-pointer flex hover:scale-105 hover:shadow-lg hover:shadow-sky-500/50 hover:ring-2 hover:ring-sky-500/50 active:bg-sky-800' type='submit'>{contentPage.contact.submit} <span className='ms-2'><PaperPlane className='w-6' /></span></button>
    </form>
  )
}
